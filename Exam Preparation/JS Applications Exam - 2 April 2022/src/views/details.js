...
const detailsPageTemplate = (pet, donations, hasUser, canDonate, isOwner, onDelete, onDonate) => html`
...
export async function displayDetailsView(ctx){
    ...
    ctx.render(detailsPageTemplate(pet, donations * 100, hasUser, canDonate, isOwner, onDelete, onDonate));
